...
#        sys.stdout.write("{0}\t{1}\n".format(previous_key, sum_of_values))
        if (sum_of_counts>114):
                sys.stdout.write("{0}\t{1}\t{2}\t{3}\n".format(previous_key, sum_of_values,sum_of_counts,sum_of_value/sum_of_counts))        
...
sys.stdout.write("{0}\t{1}\t{2}\t{3}\n".format(previous_key, sum_of_values,sum_of_counts,sum_of_values/sum_of_counts))
